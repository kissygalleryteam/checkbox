 ...
 * @module checkbox
 **/
KISSY.add('gallery/checkbox/1.4/index',function(S, Base, Node, Radio) {
    var $ = Node.all;
    /**
     * @name Checkbox
    ...
    S.extend(Checkbox, Base, /** @lends Checkbox.prototype*/ {
        ...
        ATTRS: /** @lends Checkbox.prototype*/
        {
             ...
             */
            cssUrl: {
                value: 'gallery/checkbox/1.4/style.css'
            },
            /**
             * 是否需要label for的对应
             * @default false
    ...
    requires: ['base', 'node', 'gallery/radio/1.4/index']
});
