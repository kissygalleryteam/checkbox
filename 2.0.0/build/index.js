...
kg/checkbox/2.0.0/index

*/
/**
 * @fileoverview checkbox 美化组件
 * @author bofang.zxj<bofang.zxj@taobao.com>
 * @module checkbox
 **/
KISSY.add('kg/checkbox/2.0.0/index',function(S, Base, Node, Radio) {
    var $ = Node.all;
    /**
     * @name Checkbox
    ...
    S.extend(Checkbox, Base, /** @lends Checkbox.prototype*/ {
        ...
        ATTRS: /** @lends Checkbox.prototype*/
        {
            ...
            /**
             * css模块路径
             * @default kg/form/1.1/checkbox/themes/default/style2.css
             */
            cssUrl: {
                value: 'kg/checkbox/2.0.0/style.css'
            },
            /**
             * 是否需要label for的对应
             * @default false
    ...
    requires: ['base', 'node', 'kg/radio/2.0.0/index']
});
